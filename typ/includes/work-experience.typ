    ...
    , box[
        *Software Engineering Intern* \
        Trail of Bits. Remote.
          - *C Language Toolsmithing*. Created Macroni, a C static analysis tool that combines Trail of Bits’ tools PASTA and VAST to lower C preprocessor macros down to MLIR. Macroni is available on #link("https://github.com/trailofbits/macroni")[GitHub].
